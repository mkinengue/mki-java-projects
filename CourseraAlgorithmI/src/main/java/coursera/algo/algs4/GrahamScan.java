...
public class GrahamScan {
    ...
    public GrahamScan(Point2D[] pts) {
        ...
        hull.addFirst(points[0]);       // p[0] is first extreme point
        ...
        hull.addFirst(points[k2-1]);    // points[k2-1] is second extreme point
    ...
    public Iterable<Point2D> hull() {
        ...
        for (Point2D p : hull) s.addFirst(p);
        return s;
    }
