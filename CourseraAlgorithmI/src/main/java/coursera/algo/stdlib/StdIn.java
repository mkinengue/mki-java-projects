...
/**
 * <i>Standard input</i>. This class provides methods for reading strings and numbers from standard input.
 * <p>
 * The Locale used is: language = English, country = US. This is consistent with the formatting conventions with Java
 * floating-point literals, command-line arguments (via <tt>Double.parseDouble()</tt>) and standard output (via
 * <tt>System.out.print()</tt>). It ensures that standard input works with the input files used in the textbook.
 * <p>
...
public final class StdIn {
	...
	public static char readChar() {
		...
		final String s = scanner.findWithinHorizon("(?s).", 1);
		return s.charAt(0);
	}
	...
	public static int[] readInts() {
		final String[] fields = readAll().trim().split("\\s+");
