...
import fr.perso.sudoku.bean.Column;
import fr.perso.sudoku.bean.Region;
import fr.perso.sudoku.bean.Row;
import fr.perso.sudoku.exception.InvalidRowException;
import fr.perso.sudoku.exception.NotValidException;
import fr.perso.sudoku.exception.SudokuException;
import fr.perso.sudoku.logger.LogUtils;
import fr.perso.sudoku.methodes.Methode;
import fr.perso.sudoku.methodes.impl.Singleton;
import fr.perso.sudoku.methodes.impl.SingletonCache;
import fr.perso.sudoku.methodes.impl.SingletonNu;
import fr.perso.sudoku.utils.SudokuUtils;
