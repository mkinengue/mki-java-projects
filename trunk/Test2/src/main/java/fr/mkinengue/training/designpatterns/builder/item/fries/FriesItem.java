package fr.mkinengue.training.designpatterns.builder.item.fries;

import fr.mkinengue.training.designpatterns.builder.item.Item;
import fr.mkinengue.training.designpatterns.builder.pack.Envelop;
import fr.mkinengue.training.designpatterns.builder.pack.Packing;


public abstract class FriesItem implements Item {
